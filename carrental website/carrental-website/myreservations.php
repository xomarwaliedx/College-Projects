          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="indexcustomer.php">Back</a></li>
                    </ul>
               </div>
            ...
            <tbody>
              ...
              ?>
                  ...
                  <tr>
                    ...
                    <td><a href="deletereservation2.php?reservation_number=<?php echo $data['reservation_number']?>">Delete Reservation</a> </td>
